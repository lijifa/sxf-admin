...
@connect(({ partnerchange, loading }) => ({
  result: partnerchange.dataHis,
  loading: loading.effects['partnerchange/searchchange'] ? true : false,
}))
@Form.create()
...
export default class Coin extends Component {
  state = {
    ...
    queryParam: {
      ...
      endDate: '',
      condition: {
        partnerMapId: this.props.detailData.partnerMapId,
    ...
    return (
      <div>
        ...
        <Card key={'b'}
          ...
          title={<span className={styles.tableTitle}><Icon type="appstore-o" /> 渠道变更历史
