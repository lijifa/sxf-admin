          ...
          <Row gutter={16}>
            <Col span={8}>
              <div>
                ...
                <p style={detailText}>{detailData ? getObjStatus(settleTSelect, detailData.settleT) : '-'}</p>
              </div>
            </Col>
          </Row>
          ...
          <Row gutter={16}>
            <Col span={8}>
              <div>
                ...
                <p style={detailText}>{detailData ? getObjStatus(settleFlagSelect, detailData.settleFlag) : '-'}</p>
              </div>
            </Col>
            <Col span={8}>
              <div>
                <p style={detailTitle}>结算币种</p>
                <p style={detailText}>{detailData ? detailData.coinName : ' - '}</p>
              </div>
            </Col>
          </Row>
          ...
          <Row gutter={24}>
            <Col span={8}>
              <div>
                ...
                <p style={detailText}>{detailData ? covertMoney2Yuan(detailData.settleTopAmt) : '-'} 元</p>
              </div>
            </Col>
            <Col span={16}>
              <div>
                <p style={detailTitle}>结算划拨最低金额（每笔）</p>
                <p style={detailText}>{detailData ? covertMoney2Yuan(detailData.settleOffAmt) : '-'} 元</p>
              </div>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={16}>
              <div>
                ...
                <p style={detailText}>{ detailData ? getObjStatus(acctTypeSelect, detailData.settleAcctType) : ' - '}</p>
              </div>
            </Col>
          </Row>
            ...
            <Row gutter={16}>
              <Col span={16}>
                <div>
                  ...
                  <p style={detailText}>{ detailData ? detailData.settleAcctName1 : ' - ' }</p>
                </div>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={16}>
                <div>
                  ...
                  <p style={detailText}>{ detailData ? detailData.settleAcctNo1 : ' - ' }</p>
                </div>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={16}>
                <div>
                  ...
                  <p style={detailText}>{ detailData ? detailData.settleBidName1 : ' - ' }</p>
                </div>
              </Col>
            </Row>
          </div>
            ...
            <Row gutter={16}>
              <Col span={16}>
                <div>
                  ...
                  <p style={detailText}>{ detailData ? detailData.settleAcctName2 : ' - ' }</p>
                </div>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={16}>
                <div>
                  ...
                  <p style={detailText}>{ detailData ? detailData.settleAcctNo2 : ' - '}</p>
                </div>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={16}>
                <div>
                  <p style={detailTitle}>开户银行</p>
                  <p style={detailText}>{ detailData ? detailData.settleBidName2 : ' - '}</p>
                </div>
              </Col>
            </Row>
          </div>
