...
import {formatTime, responseMsg, getObjStatus, toDateTime, getOrgData} from '@/utils/utils';
...
@connect(({ merchant, loading }) => ({
  result: merchant.data,
  loading: loading.effects['merchant/search'] ? true : false,
}))
...
export default class Partner extends Component {
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      oldQuery.condition['checkStatus'] = 1
      oldQuery.condition['changType'] = 0
  ...
  render() {
    ...
    const columns = [
      ...
      { title: '状态', width: 80, dataIndex: 'checkStatusText', key: 'checkStatusText' },
      { title: '创建时间', width: 200, dataIndex: 'timeCreate', key: 'timeCreate' },
      { title: '操作',
        key: 'operation',
        width: 150,
        fixed: 'right',
    ...
    return (
      <div>
        ...
        <Card key={'b'}
          ...
          title={<span className={styles.tableTitle}><Icon type="appstore-o" /> 商户进件
