...
@connect(({ merchantcheck, loading }) => ({
  result: merchantcheck.data,
  loading: loading.effects['merchantcheck/search'] ? true : false,
}))
@Form.create()

export default class Mcheck extends Component {
  state = {
    detailId: null,
    detailData: null,
    detailVisible: false,
    ...
    return (
      <div>
        ...
        <Card key={'b'}
          ...
          title={<span className={styles.tableTitle}><Icon type="appstore-o" /> 商户审核
