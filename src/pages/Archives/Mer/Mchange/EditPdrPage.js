      ...
      if (isAdd) {
        for (let i = 0; i < 2; i++) {
          payTypeRender.push(<Timeline.Item key={num}>
            ...
            <FormItem >
              {getFieldDecorator(`mdrList[${num}]['paytypeMapId\']`, Object.assign({}, {}, {initialValue: detailData ? item.paytypeMapId : item.paytypeId}))
              (
                <Input type='hidden' placeholder='支付方式'/>
              )}
            </FormItem>
            ...
            <FormItem >
              {getFieldDecorator(`mdrList[${num}]['cardCd\']`, Object.assign({}, {}, {initialValue: detailData ? item.cardCd : i}))
              (
                <Input type='hidden' placeholder='修改订单编号'/>
              )}
            </FormItem>
        ...
        payTypeRender.push(<Timeline.Item key={num}>
          ...
          <FormItem >
            {getFieldDecorator(`mdrList[${num}]['cardCd\']`, Object.assign({}, {}, {initialValue: detailData ? item.cardCd : 9}))
            (
              <Input type='hidden' placeholder='修改订单编号'/>
            )}
          </FormItem>
