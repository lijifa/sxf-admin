  ...
  componentWillReceiveProps(nextProps) {
    ...
    if ( detailData && nextFlag == 0 ) {
      this.setState({
        ...
        partnerMapId: detailData ? detailData.partnerMapId : 0,
        partnerMapIdP: detailData ? detailData.partnerMapIdP : 0,
        instMapId: detailData ? detailData.instMapId : 0
      })
    }
  }
  ...
  handleSubmit = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const values = {
        ...
        merMapIdP,                  //商户父Id
        merLevel,                   //商户级别
        flagStatus: detailData ? detailData.flagStatus : 2,
        paytypeOpen: 0,             //支付开通
        contractNo: '11',                 //合同编号
