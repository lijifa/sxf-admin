          ...
          <Row gutter={16}>
            ...
            <Col span={24}>
              <FormItem label='机构ID'>
                ...
                (<Input placeholder='请输入机构ID' disabled={detailData ? true : false}/>)}
              </FormItem>
            </Col>
            <Col span={24}>
              <FormItem label='通道编号'>
                {getFieldDecorator('hostMapId', Object.assign({}, decoratorConfig, {initialValue: detailData ? detailData.hostMapId : 0}))
                (<Input placeholder='请输入通道编号' disabled={detailData ? true : false} />)}
              </FormItem>
            </Col>
            <Col span={24}>
              <FormItem label='对称密钥索引'>
                {getFieldDecorator('keyIndex', Object.assign({}, decoratorConfig, {initialValue: detailData ? detailData.keyIndex : 0}))
                (<Input placeholder='请输入对称密钥索引' disabled={detailData ? true : false}/>)}
              </FormItem>
            </Col>
            <Col span={24}>
              <FormItem label='主密钥'>
