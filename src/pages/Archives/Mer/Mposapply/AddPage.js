      ...
      <div className={styles.editFormItem}>
        <Form layout='vertical' onSubmit={this.handleSubmit}>
          <FormItem className='inputW210' label='安装商户'>
            {getFieldDecorator('merName', Object.assign({}, decoratorConfig, {initialValue: merMapId}))
            (
              <MerSearch
                placeholder="请输入安装商户"
          ...
          <FormItem className='inputW210' label='POS终端数量'>
            ...
            (
              <Input placeholder='请输入POS终端数量' />
            )}
          </FormItem>
          <FormItem className='inputW210' label='通讯参数'>
            {getFieldDecorator('poscomId', Object.assign({}, decoratorConfig, {initialValue: detailData ? detailData.poscomId : ''}))
            (
