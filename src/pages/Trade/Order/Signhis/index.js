...
export default class Coin extends Component {
  ...
  render() {
    ...
    const columns = [
      { title: '数字代码', dataIndex: 'id', key: 'id' },
      { title: '字母代码', dataIndex: 'coinCode', key: 'coinCode' },
      { title: '币种名称', dataIndex: 'coinName', key: 'coinName' },
      { title: '币种符号', dataIndex: 'coinSymbol', key: 'coinSymbol' },
      { title: '币种单位', dataIndex: 'coinUnit', key: 'coinUnit' },
    ...
    return (
      <div>
        ...
        <Card key={'b'}
          ...
          title={<span className={styles.tableTitle}><Icon type="appstore-o" /> 币种代码
