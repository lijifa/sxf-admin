...
import { Row, Card, Form, Input, Button, Table, Icon, Divider, Drawer, Popconfirm, TimePicker } from "antd";
...
export default class Lang extends Component {
  state = {
    ...
    queryParam: {
      ...
      endDate: '',
      condition: {
        transPosDateStart: moment().format('YYYYMMDD'),
        transPosDateEnd: moment().format('YYYYMMDD'),
      }
    }
  };
    ...
    return (
      <div>
        ...
        <Card key={'b'}
          ...
          title={<span className={styles.tableTitle}><Icon type="appstore-o" /> 当日交易流水
